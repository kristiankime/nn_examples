...
from util.nn import nn_dashboard_skill_inverse
...
run_dir = os.path.join('dashboards', f'nn_dashboard_inverse')
...
#     nn_dashboard_skill_inverse(ac, probability_model, num_diffs=0, num_skills=diff_and_skill_num, diff_ind=-1)
#     for ac in snapshots_train_embedded.to_numpy()]
# print(f"saving dashboard")
# np.savetxt(os.path.join(run_dir, f'nn_dashboard_inverse_train.csv'), snapshots_train_embedded_dashboard, fmt='%1.4f', delimiter=",")
# # ========= answer / label for current question
# print(f"saving answers")
# np.savetxt(os.path.join(run_dir, f'nn_dashboard_inverse_train_answers.csv'), snapshots_train_labels, fmt='%1.4f', delimiter=",")
...
print(f"saving dashboard")
np.savetxt(os.path.join(run_dir, f'nn_dashboard_inverse_validate.csv'), snapshots_validate_embedded_dashboard, fmt='%1.4f', delimiter=",")
# ========= answer / label for current question
print(f"saving answers")
np.savetxt(os.path.join(run_dir, f'nn_dashboard_inverse_validate_answers.csv'), snapshots_validate_labels, fmt='%1.4f', delimiter=",")
...
print(f"saving dashboard")
np.savetxt(os.path.join(run_dir, f'nn_dashboard_inverse_test.csv'), snapshots_test_embedded_dashboard, fmt='%1.4f', delimiter=",")
# ========= answer / label for current question
print(f"saving answers")
np.savetxt(os.path.join(run_dir, f'nn_dashboard_inverse_test_answers.csv'), snapshots_test_labels, fmt='%1.4f', delimiter=",")
