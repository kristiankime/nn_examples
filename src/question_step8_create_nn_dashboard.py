...
run_dir = os.path.join('dashboards', f'nn_dashboard')
...
np.savetxt(os.path.join(run_dir, f'nn_dashboard_diff_none_train.csv'), snapshots_train_embedded_dashboard, fmt='%1.4f', delimiter=",")
# ========= answer / label for current question
print(f"saving answers")
np.savetxt(os.path.join(run_dir, f'nn_dashboard_diff_none_train_answers.csv'), snapshots_train_labels, fmt='%1.4f', delimiter=",")
...
print(f"saving dashboard")
np.savetxt(os.path.join(run_dir, f'nn_dashboard_diff_none_test.csv'), snapshots_test_embedded_dashboard, fmt='%1.4f', delimiter=",")
# ========= answer / label for current question
print(f"saving answers")
np.savetxt(os.path.join(run_dir, f'nn_dashboard_diff_none_test_answers.csv'), snapshots_test_labels, fmt='%1.4f', delimiter=",")
