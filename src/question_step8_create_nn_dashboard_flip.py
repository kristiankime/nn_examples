...
from util.nn import nn_dashboard_skill_flip
...
run_dir = os.path.join('dashboards', f'nn_dashboard_flip')
...
#     nn_dashboard_skill_flip(ac, probability_model, num_diffs=0, num_skills=diff_and_skill_num, diff_ind=-1)
#     for ac in snapshots_train_embedded.to_numpy()]
# print(f"saving dashboard")
# np.savetxt(os.path.join(run_dir, f'nn_dashboard_flip_train.csv'), snapshots_train_embedded_dashboard, fmt='%1.4f', delimiter=",")
# # ========= answer / label for current question
# print(f"saving answers")
# np.savetxt(os.path.join(run_dir, f'nn_dashboard_flip_train_answers.csv'), snapshots_train_labels, fmt='%1.4f', delimiter=",")
...
print(f"saving dashboard")
np.savetxt(os.path.join(run_dir, f'nn_dashboard_flip_validate.csv'), snapshots_validate_embedded_dashboard, fmt='%1.4f', delimiter=",")
# ========= answer / label for current question
print(f"saving answers")
np.savetxt(os.path.join(run_dir, f'nn_dashboard_flip_validate_answers.csv'), snapshots_validate_labels, fmt='%1.4f', delimiter=",")
...
print(f"saving dashboard")
np.savetxt(os.path.join(run_dir, f'nn_dashboard_flip_test.csv'), snapshots_test_embedded_dashboard, fmt='%1.4f', delimiter=",")
# ========= answer / label for current question
print(f"saving answers")
np.savetxt(os.path.join(run_dir, f'nn_dashboard_flip_test_answers.csv'), snapshots_test_labels, fmt='%1.4f', delimiter=",")
