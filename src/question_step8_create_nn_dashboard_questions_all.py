...
from util.nn import nn_dashboard_skill_all_questions
from util.questions import questions_details_prep
...
run_dir = os.path.join('dashboards', f'nn_dashboard_questions_all')
...
questions_skills = questions_details_prep(os.path.join('data', 'questions_details.243diff.csv'))
...
# np.savetxt(os.path.join(run_dir, f'nn_dashboard_questions_all_train.csv'), snapshots_train_embedded_dashboard, fmt='%1.4f', delimiter=",")
# # ========= answer / label for current question
# print(f"saving answers")
# np.savetxt(os.path.join(run_dir, f'nn_dashboard_questions_all_train_answers.csv'), snapshots_train_labels, fmt='%1.4f', delimiter=",")
