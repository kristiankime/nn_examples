...
# load dir
load_nn_dir = os.path.join('dashboards', f'nn_dashboard_neg')
...
run_dir = os.path.join('dashboards', f'compare_dashboards_neg')
...
nn_dashboard = pd.read_csv(os.path.join(load_nn_dir, f'nn_dashboard_neg_validate.csv'), header=None).iloc[:,0:26]
