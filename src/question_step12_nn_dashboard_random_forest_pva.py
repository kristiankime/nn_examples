...
# output location
model_dir = os.path.join('dashboards', f'nn_dashboard', f'run_random_forest')
run_dir = os.path.join('dashboards', f'nn_dashboard', f'run_random_forest', 'pred_vs_actual')
...
nn_dashboard_diff_none_validate = pd.io.parsers.read_csv(os.path.join('dashboards', f'nn_dashboard', f'nn_dashboard_diff_none_validate.csv'), delimiter=",", header=None)
nn_dashboard_diff_none_validate_answers = pd.io.parsers.read_csv(os.path.join('dashboards', f'nn_dashboard', f'nn_dashboard_diff_none_validate_answers.csv'), delimiter=",", header=None)
...
nn_dashboard_diff_none_validate_stats.to_csv(os.path.join(run_dir, 'random_forest_validate_pva.csv'), index=False)
