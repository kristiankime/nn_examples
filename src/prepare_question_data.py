...
questions_links.loc[:,'question']
# questions_links.loc[:,['p
# roblem_source','question_id']].rename(columns={'problem_source': 'newName1', 'question_id': 'newName2'})

questions_details = questions_details_prep(os.path.join('data' , 'questions_details.243diff.csv'))
# questions_details.dtypes
# questions_details.loc[:,'question']
...
answers_history = answers_history.sort_values(by=['anon_id', 'timestamp'], ascending=[True, False])
