...
# ------- Validation
snapshots_validate = read_numpy_3d_array_from_txt(os.path.join('outputs', 'pick1', f'snapshot_validate_l{full_history_length}_s1.txt'))
...
np.savetxt(os.path.join('outputs', 'pick1', f'snapshots_validate_embedded_t{model_history_length}_l{lstm_layer_size}_e{epochs}_s1.csv.gz'), snapshots_validate_embedded, fmt='%1.4f', delimiter=",")
np.savetxt(os.path.join('outputs', 'pick1', f'snapshots_validate_labels_t{model_history_length}_l{lstm_layer_size}_e{epochs}_s1.csv.gz'), snapshots_validate_labels, fmt='%1.4f', delimiter=",")
print(f"saved snapshots validate")

# ------- Test
snapshots_test = read_numpy_3d_array_from_txt(os.path.join('outputs', 'pick1', f'snapshot_test_l{full_history_length}_s1.txt'))
...
np.savetxt(os.path.join('outputs', 'pick1', f'snapshots_test_embedded_t{model_history_length}_l{lstm_layer_size}_e{epochs}_s1.csv.gz'), snapshots_test_embedded, fmt='%1.4f', delimiter=",")
np.savetxt(os.path.join('outputs', 'pick1', f'snapshots_test_labels_t{model_history_length}_l{lstm_layer_size}_e{epochs}_s1.csv.gz'), snapshots_test_labels, fmt='%1.4f', delimiter=",")
